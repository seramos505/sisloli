...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        $menus=[
            ...
            ["parent_menu" => 0,"nombre" => "Ayuda","url" => "javascript:;","orden" => 5,"icono" => "fas fa-exclamation-circle"],
            ...
            ["parent_menu" => 3,"nombre" => "Ventas Diario","url" => "venta-diario","orden" => 1,"icono" => "fas fa-circle"],
